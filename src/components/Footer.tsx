      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 lg:gap-12 mb-16">
          ...
          <div className="lg:col-span-2 pr-0 lg:pr-8">
            <a href="#home" className="flex items-center gap-2.5 mb-4 group text-decoration-none">
              <div className="w-7 h-7 rounded-full bg-gradient-to-tr from-[#5545ff] to-[#8a7bff] flex items-center justify-center shadow-[0_0_12px_rgba(117,104,255,0.5)]">
            ...
            <p className="text-sm text-[#9396b2] max-w-sm leading-relaxed mb-6 font-light">
              The AI Creative Suite for Makers Who Think in Images.
            </p>
        ...
        <div className="pt-8 border-t border-[#7864ff]/10 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-[#787a94]">
          <p>© 2025 ArchAI Inc. All Rights Reserved.</p>
